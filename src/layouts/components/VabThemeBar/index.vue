          ...
          <el-form ref="form" :model="theme" label-position="top">
            <el-form-item label="主题">
              ...
              <el-radio-group v-model="theme.name">
                ...
                <el-radio-button label="blue">荣耀典藏</el-radio-button>
  ...
  methods: {
    ...
    handleSetTheme() {
      ...
      document.getElementsByTagName(
        'body'
      )[0].className = `network-pro-theme-${name} vab-background`
    ...
    handleSetDfaultTheme() {
      ...
      document
        ...
        .classList.remove(`network-pro-theme-${name} vab-background`)
